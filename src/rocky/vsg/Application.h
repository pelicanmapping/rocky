...
namespace ROCKY_NAMESPACE
{
    ...
    public: // public properties
        ...
        //! Maximum number of unique Overlay/Decal textures that can be projected
        //! concurrently. Set this before realize() or the first frame. At startup
        //! it is clamped to the selected Vulkan device's descriptor limits.
        std::uint32_t projectedTextureCapacity =
