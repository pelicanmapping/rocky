...
namespace ROCKY_NAMESPACE
{
    ...
    */
    class ROCKY_VSG_EXPORT MeshSystemNode : public vsg::Inherit<ECS::VSG_SystemNode, MeshSystemNode>
    {
    public:
     ...
     */
    class ROCKY_VSG_EXPORT MeshSystem : public ECS::VSG_System
    {
    public:
    ...
    */
    class ROCKY_VSG_EXPORT NodeSystemNode : public vsg::Inherit<ECS::VSG_SystemNode, NodeSystemNode>
    {
    public:
    ...
    */
    class ROCKY_VSG_EXPORT NodeSystem : public ECS::VSG_System
    {
    public:
